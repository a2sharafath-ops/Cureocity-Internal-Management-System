  ...
  if (tab === "dishes") {
    ...
    const [dsh, fds] = await Promise.all([
      fetchAllRows<Raw>((from, to) => supabase.from("dishes")
        .select("id, name, cuisine, cooked_g, servings, serving_label, notes, source, source_kcal, source_carb_g, source_protein_g, source_fat_g, source_fibre_g, portion_g, portion_g_source, approved, approved_by, dish_items(food_code, name, raw_g, raw_g_source, seq)")
