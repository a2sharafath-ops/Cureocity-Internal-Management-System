...
export default function WorkspaceTabs({ active }: { active: "pro" | "trainer" | "meals" | "careteam" }) {
  return (
    <div style={{ marginBottom: 16 }}>
      <Link href="/workspace" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "var(--brand-text)", textDecoration: "none", fontSize: 12.5, fontWeight: 600, marginBottom: 8 }}>← Back to my Workspace</Link>
