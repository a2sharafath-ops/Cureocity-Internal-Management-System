...
export default function CoachCopilot({
  ...
  return <div style={{ display: "grid", gap: 16, maxWidth: 1120 }}>
    <div><h2 style={{ fontSize: 18, margin: "0 0 3px" }}>Coach Copilot</h2><div style={{ color: "var(--muted)", fontSize: 12.5 }}>Draft-only behavioural coaching support. You remain responsible for checking every word and choosing the next action.</div></div>
    <div style={{ background: "#eff6ff", color: "#1e3a8a", border: "1px solid #bfdbfe", borderRadius: 10, padding: "10px 13px", fontSize: 12 }}><b>Human approval is mandatory.</b> The Copilot cannot diagnose, interpret tests, change medication, prescribe diet or exercise, provide therapy, override a clinician or close a safety alert.</div>
