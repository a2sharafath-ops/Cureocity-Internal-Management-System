...
- Every role other than Health Coach, Super Admin, Administrator, Manager, Medical Director, Front Desk, Doctor, Fitness Trainer, Dietitian, Psychologist, Finance, and the bounded Staff navigation pilot is deliberately inert. A future-looking environment flag alone cannot activate one of those roles because its tasks and boundaries have not been approved or implemented.
...
Until those conditions are met, the correct application behavior is the current one: Health Coach and Super Admin remain guarded pilots; the implemented deterministic role pilots remain default-off behind their versioned migrations and role flags; roles without an approved manifest remain inert; voice remains disabled; and clients have no Cureocity Assistant access.
