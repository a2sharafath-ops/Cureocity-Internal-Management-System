...
- Every role other than Health Coach, Super Admin, Administrator, Front Desk, Fitness Trainer, and the bounded Staff navigation pilot is deliberately inert. A future-looking environment flag alone cannot activate one of those roles because its tasks and boundaries have not been approved or implemented.
